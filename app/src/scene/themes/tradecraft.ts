...
/**
 * TRADECRAFT — the founding look, extracted verbatim: 1960s-70s analog
 * spycraft. Brushed aluminum field case, phenolic plates, brass fittings,
 * warm desk-lamp key light, amber phosphor readouts, field-used patina.
 */
export const tradecraft: SceneTheme = {
  id: 'tradecraft',
  label: 'Tradecraft',
  statement: 'Analog spycraft, 1968: brushed aluminum, phenolic, brass, and a warm desk lamp.',
