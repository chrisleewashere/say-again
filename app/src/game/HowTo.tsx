  ...
  return (
    <main className="screen crt">
      <div className="fi-frame">
        ...
        <p className="fi-banner">** Two stations · one screen · one printed manual **</p>
        ...
        <section className="card setup-section">
          ...
          <ol className="fi-steps">
            <li><span><strong>Agent describes</strong> what's on screen — colors, shapes, letters, positions.</span></li>
            <li><span><strong>Handler finds</strong> the matching section in the manual and works the rules.</span></li>
            <li><span><strong>Handler directs</strong>; the Agent confirms before touching anything.</span></li>
            <li><span><strong>Ask when unsure!</strong> "Which one?", "Say that again?", and "Do you mean the striped one?" are power moves, not weaknesses.</span></li>
          </ol>
        </section>
